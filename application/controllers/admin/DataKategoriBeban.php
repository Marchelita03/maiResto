...
class dataKategoriBeban extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['kategori'] = $this->db->query("SELECT * FROM `kategori` WHERE jenis = 'beban'")->result_array();

		$this->load->view('templates_admin/header',$data);
 		$this->load->view('templates_admin/sidebar');
		$this->load->view('admin/dataKategoriBeban',$data);
	...
	public function tambahData()
	{
		...
		$this->load->view('templates_admin/header',$data);
 		$this->load->view('templates_admin/sidebar');
		$this->load->view('admin/tambahDataKategoriBeban',$data);
		$this->load->view('templates_admin/footer');
	}
	...
	public function tambahDataAksi()
	{
		...
		if($this->form_validation->run() == FALSE) {
			...
			redirect('admin/dataKategoriBeban');
	...
	public function updateData($id)
	{
		...
		$this->load->view('templates_admin/header',$data);
 		$this->load->view('templates_admin/sidebar');
		$this->load->view('admin/updateDataKateoriBeban',$data);
		$this->load->view('templates_admin/footer');
	}
