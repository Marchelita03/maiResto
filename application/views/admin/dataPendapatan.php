...
<a class="mb-3 mt-2 btn btn-sm btn-primary" href="<?php echo base_url('admin/DataKategoriPendapatan/') ?>"><i class="fas fa-eye"></i> Kategori</a>

<a class="mb-3 mt-2 btn btn-sm btn-success" href="<?php echo base_url('admin/DataPendapatan/tambahData/') ?>"><i class="fas fa-plus"></i> Tambah Data</a>
	...
	<tbody>
		...
		?>
			<tr>
				...
				<td>
					<center>
						<a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/DataPendapatan/updateData/'.$m['id_keuangan']) ?>"><i class="fas fa-edit"></i></a>
						<a onclick="return confirm('Yakin Hapus?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/DataPendapatan/deleteData/'.$m['id_keuangan']) ?>"><i class="fas fa-trash"></i></a>
					</center>
				</td>
			</tr>
		<?php endforeach; ?>
