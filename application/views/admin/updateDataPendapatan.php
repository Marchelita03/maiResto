<div class="container-fluid">
    ...
    <div class="card" style="width: 60%; margin-bottom: 100px">
    	<div class="card-body">
    		...
    		<form method="POST" action="<?php echo base_url('admin/DataPendapatan/updateDataAksi') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="pendapatan" class="form-control" value="<?php echo $pd->pendapatan ?>">
