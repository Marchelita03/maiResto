...
<a class="mb-3 mt-2 btn btn-sm btn-success" href="<?php echo base_url('umum/DataPenjualan/tambahData/') ?>"><i class="fas fa-plus"></i> Tambah Data</a>
	...
	<tbody>
		...
		?>
			<tr>
				...
				<td>
					<center>
						<a class="btn btn-sm btn-primary" href="<?php echo base_url('umum/DataPenjualan/updateData/'.$pj['id_penjualan']) ?>"><i class="fas fa-edit"></i></a>
						<a onclick="return confirm('Yakin Hapus?')" class="btn btn-sm btn-danger" href="<?php echo base_url('umum/DataPenjualan/deleteData/'.$pj['id_penjualan']) ?>"><i class="fas fa-trash"></i></a>
					</center>
				</td>
			</tr>
